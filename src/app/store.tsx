...
const STORE_KEYS = {
  nyc: {
    name: 'Clever Coffee NYC',
    key: '$2y$10$pTJz/7e7yHeFgZBQj87aNO4.uDCTgRkLXS9HhnCNV55gNJ61udZHm',
    token: '8k5RlcKp',
  },
  sf: {
    name: 'Clever Coffee SF',
    key: '$2y$10$vjQHa0qrH41FcGy.pd75ROCFRNOGd7wEbV1E7kPsXALfGGtDgPh4K',
    token: '4sVCwmG2',
  },
};
...
export default function CleverCoffee() {
  ...
  const currentStore = STORE_KEYS[store as keyof typeof STORE_KEYS];
  ...
  if (deepLinkMutation.isPending || statusCheckMutation.isPending) {
    return (
      <ActivityIndicator
        ...
        className='flex-1 items-center justify-center bg-coffee-50 dark:bg-coffee-700'
      />
    );
  }
    ...
    <>
      <Stack.Screen
        options={{
          ...
          headerLargeStyle: {
            backgroundColor: colorScheme === 'dark' ? '#2C1810' : '#F5EDE3',
          },
